    ...
    messages: [
      {
        role: 'assistant',
        content:
          'Hello! I am ready for your future DeepSeek backend. Ask about programmes, jobs, My List, or the Cornerstone site.'
      }
    ],
    sending: false
  };
  ...
  async function sendMessage(text) {
    ...
    try {
      ...
      const message = isMissingRoute
        ? 'POST /api/chat is not connected yet. Add your DeepSeek backend and try again.'
        : err.message;
